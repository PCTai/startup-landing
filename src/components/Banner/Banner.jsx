        ...
        <div className="banner-constainer">
          <div className="banner-content">
            ...
            <div className="banner-btn">
              ...
              <div onClick={handleToggleOpen}  className={`modal-video ${isOpen ? 'open' :''}`}>
              ...
              <button onClick={handleToggleOpen} className="btn btn-watch">Watch Video</button>
            </div>
            <div className="banner-support">
                <h3 className="support-title">Sponsored by:</h3>
                <div className="banner-support-items">
          ...
          <div className="banner-image">
            <img className="banner-img" src="https://startup-app-modern.vercel.app/_next/static/images/banner-thumb-10b963235571f7743a4fdb04280058ad.png" alt="" />
          </div>
        </div>
      </div>
    </div>
